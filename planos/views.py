...
# 1. destroy() ahora tiene reintentos (hasta 3 intentos)
# 2. Usa backoff exponencial (0.3s, 0.6s, 0.9s)
# 3. Devuelve 503 (Service Unavailable) cuando la DB está bloqueada
# 4. Maneja específicamente OperationalError con "database is locked"
# 5. eliminar_todos() también tiene la misma lógica de reintentos
# """
            ...
            try:
                ...
                if "database is locked" in str(e).lower():
                    if attempt < max_retries - 1:
                        ...
                        print(f"⚠️  DB bloqueada, reintento {attempt + 1}/{max_retries} en {wait_time}s")
